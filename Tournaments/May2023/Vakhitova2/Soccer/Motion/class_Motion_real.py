...
class Motion_real(Motion1):
    ...
    def seek_Ball_In_Pose(self, fast_Reaction_On, penalty_Goalkeeper = False, with_Localization = True, last_pose=0):
        ...
        pos = (-last_pose / 180) * 16
        if -16 > pos >= 0:
            head_pose_seq = head_pose_seq[pos:] + head_pose_seq[:pos]
