...
def main_procedure():
    ...
    logger.info(f'role = {sys.argv[5]} team_id ={int(sys.argv[2])} robot_color = {sys.argv[3]} robot_number ={int(sys.argv[4])}')
    ...
    role = sys.argv[5]
    #--------------------------------------------------------------------------------------------------------------!!
    logger.info(f'role = {role} team_id ={team_id} robot_color = {sys.argv[3]} robot_number ={int(sys.argv[4])}')
    if team_id > 0:
