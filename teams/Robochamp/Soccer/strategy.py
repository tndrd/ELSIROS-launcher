...
class Forward_Vector_Matrix:
    ...
    in year 2021.
    Matrix is coded in file newstatagydata.json  This file is readable and editable as well as
    ...
    Strategy data is imported from newstatagydata.json file into self.glob.strategy_data list.
    usage:  
...
class Player():
    ...
    def forward_main_cycle(self, pressed_button):
        ...
        while (True):
            ...
            self.f.dir_To_Guest()                                           # loading kick direction from newstatagydata.json into self.f.direction_To_Guest
